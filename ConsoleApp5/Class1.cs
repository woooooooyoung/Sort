...
namespace ConsoleApp5
{
    internal class Class1
    {
        ...
        // 하나의 피벗을 잡고 그 값보다 작으면 왼쪽 크면 오른쪽으로 보낸다.
        // 그 피벗을 기준으로 왼쪽 오른쪽으로 옮기면 파티션이 두개가 된다.
        // 왼쪽,오른쪽 배열을 따로 정렬한다.
        // 왼쪽 파티션에서 아무 피벗이나 잡는다.(잡을떈 중간값이면 좋다)
        // 메모리적 부담은 적다.
        ...
        // [2] [4] [5] [6] [8] [1] [3] [7] [9]
        // 6524 
        // 865249731 [8] 65249731  
        // [8]65249731
        // [8][9]
        // i는 8보다 큰거 만날때까지 오른쪽 j는 8보다 작은거 만날때까지 왼쪽으로가다가 둘이 엇갈리면 교체해준다
        // 엇갈린 이유는 둘 중 하나가 피벗보다 큰 값을 만났기 때문이다
        // 865241739
        // 365241789
        // i와 j가 엇갈리면 엇갈린것과 피벗을 교체해준다 8(i) 3(j)
        // [8]65249731
        // [8]65249731
        // 8 65249731
        //   i      j
